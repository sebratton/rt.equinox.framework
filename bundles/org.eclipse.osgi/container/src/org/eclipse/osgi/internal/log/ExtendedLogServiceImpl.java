...
public class ExtendedLogServiceImpl implements ExtendedLogService {
	...
	private final Map<Class<? extends org.osgi.service.log.Logger>, Map<String, Logger>> loggerCache = new HashMap<Class<? extends org.osgi.service.log.Logger>, Map<String, Logger>>();
